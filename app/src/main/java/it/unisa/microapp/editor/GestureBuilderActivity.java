...
import it.unisa.microapp.activities.CatturaGesto;
...
import java.io.File;
	  ...
	  public class GestureBuilderActivity extends ListActivity {
			...
			private final File mStoreFile = new File(FileManagement.getGestureDir());
		    ...
		    public void createIconGesture(View v) {
		    	addGestureShortcut();
		    }		    
		    
		    public void destroyIconGesture(View v) {
		    	delGestureShortcut();
		    }		    
		    
		    
			//metodi per aggiungere/eliminare shortcut GestureLauncher
			private void addGestureShortcut() {
		    	
				Intent shortcutIntent = new Intent(getApplicationContext(),CatturaGesto.class);
				shortcutIntent.setAction(Intent.ACTION_MAIN);
				Intent addIntent = new Intent();
				addIntent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, shortcutIntent);
				addIntent.putExtra(Intent.EXTRA_SHORTCUT_NAME, "MicroApp Gesture");
				addIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE,
				Intent.ShortcutIconResource.fromContext(getApplicationContext(),R.drawable.gesture48));
			...
			private void delGestureShortcut() {
		...
		out:        for (String name : entries) {
		    ...
		    private class GesturesAdapter extends ArrayAdapter<NamedGesture> {
		        ...
		        void addBitmap(Long id, Bitmap bitmap) {
		            mThumbnails.put(id, new BitmapDrawable(this.getContext().getResources(), bitmap));
		        }
