...
public class InformationErrorComponent extends MAComponent 
{

	public InformationErrorComponent(String id, String description) {
		super(id, description);
	}

	@Override
	protected String getLocationQName() {
		return "it.unisa.microapp.activities.InformationErrorActivity";
	}
