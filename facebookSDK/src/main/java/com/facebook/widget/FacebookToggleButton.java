...
/**
 * Created by Leone on 05/06/2014.
 */
public class FacebookToggleButton extends ToggleButton {

        private static final String TAG = FacebookToggleButton.class.getName();
    ...
    public interface OnPermissionListener {
         ...
         */
        public FacebookToggleButton(Context context) {
            super(context);
         ...
         */
        public FacebookToggleButton(Context context, AttributeSet attrs) {
            super(context, attrs);
         ...
         */
        public FacebookToggleButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        public void setOnPermissionListener(OnPermissionListener onPermissionListener) {
        properties.setOnPermissionListener(onPermissionListener);
       }


        public OnPermissionListener getOnPermissionListener() {
        return properties.getOnPermissionListener();
        }
        ...
        private void parseAttributes(AttributeSet attrs) {
            ...
            confirmLogout = a.getBoolean(com.facebook.android.R.styleable.com_facebook_login_view_confirm_logout, true);
            fetchUserInfo = a.getBoolean(com.facebook.android.R.styleable.com_facebook_login_view_fetch_user_info, true);
            loginText ="";//a.getString(com.facebook.android.R.styleable.com_facebook_login_view_login_text);
            logoutText ="";// a.getString(com.facebook.android.R.styleable.com_facebook_login_view_logout_text);
            a.recycle();
        }
        ...
        private void setButtonText() {
            if (sessionTracker != null && sessionTracker.getOpenSession() != null) {
                setText((logoutText != null) ? logoutText :
                        getResources().getString(com.facebook.android.R.string.com_facebook_loginview_log_out_button));
            } else {
                setText((loginText != null) ? loginText :
                        getResources().getString(com.facebook.android.R.string.com_facebook_loginview_log_in_button));
            }
        }
        ...
        private class LoginClickListener implements OnClickListener {
            ...
            public void onClick(View v) {
                Log.d("FacebookToggle", "onlcick");
                Context context = getContext();
                final Session openSession = sessionTracker.getOpenSession();
                if (openSession != null) {
                    properties.getOnPermissionListener().onPermissionRequest();
                    // If the Session is currently open, it must mean we need to log out
                    if (confirmLogout) {
                        // Create a confirmation dialog
//                        String logout = getResources().getString(com.facebook.android.R.string.com_facebook_loginview_log_out_action);
//                        String cancel = getResources().getString(com.facebook.android.R.string.com_facebook_loginview_cancel_action);
//                        String message;
//                        if (user != null && user.getName() != null) {
//                            message = String.format(getResources().getString(com.facebook.android.R.string.com_facebook_loginview_logged_in_as), user.getName());
//                        } else {
//                            message = getResources().getString(com.facebook.android.R.string.com_facebook_loginview_logged_in_using_facebook);
//                        }
...
//                        builder.create().show();
                   ...
                   if (((FacebookToggleButton)v).isChecked()) {
